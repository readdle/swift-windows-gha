...
if defined GITHUB_ACTIONS (
  if /i [%SW_LEVEL%]==[WRN] (
    set "SW_LOG_FORMATTED_MESSAGE=%SW_SCOPE%%SW_PREFIX%%SW_MESSAGE%"
  ) else if /i [%SW_LEVEL%]==[ERR] (
    set "SW_LOG_FORMATTED_MESSAGE=%SW_SCOPE%%SW_PREFIX%%SW_MESSAGE%"
  ) else (
    set "SW_LOG_FORMATTED_MESSAGE=[%SW_LEVEL_COLOR%%SW_LEVEL%%SW_LOG_RESET%] %SW_SCOPE%%SW_LOG_MAGENTA%%SW_PREFIX%%SW_LOG_RESET%%SW_MESSAGE%"
  )
) else (
    set "SW_LOG_FORMATTED_MESSAGE=[%SW_LEVEL_COLOR%%SW_LEVEL%%SW_LOG_RESET%] %SW_SCOPE%%SW_LOG_MAGENTA%%SW_PREFIX%%SW_LOG_RESET%%SW_MESSAGE%"
)

echo.%SW_LOG_FORMATTED_MESSAGE%
