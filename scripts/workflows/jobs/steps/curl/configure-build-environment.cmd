...
%SW_LOG_CURL_INFO% --prefix="Build directory:   " --message="%SW_CURL_BUILD_DIR%"
%SW_LOG_CURL_INFO% --prefix="Install directory: " --message="%SW_CURL_INSTALL_DIR%"
%SW_LOG_CURL_INFO% --prefix="zlib directory:    " --message="%SW_ZLIB_DIR%"
