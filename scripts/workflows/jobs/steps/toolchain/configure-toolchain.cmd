...
cmake^
 ...
 -D CLANG_VENDOR_UTI=com.readdle.dt^
 ...
 -D CLANG_TIDY_CONFUSABLE_CHARS_GEN=%SW_CLANG_TIDY_CONFUSABLE_CHARS_GEN%^
 -D LLVM_NATIVE_TOOL_DIR=%SW_BUILD_TOOLS_DIR%^
 -D SWIFT_NATIVE_SWIFT_TOOLS_PATH=%SW_BUILD_TOOLS_DIR%^
 ...
 -D Python3_ROOT_DIR="%SW_PYTHON_DIR%"^
 -D Python3_INCLUDE_DIR="%SW_PYTHON_DIR%/include"^
 -D Python3_LIBRARY="%SW_PYTHON_DIR%/libs/python310.lib"^
